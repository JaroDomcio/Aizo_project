...
void testShellSortFrankLazarus(const string& typeName) {
    ...
    cout << "\nTESTY SHELL FRANK-LAZARUS DLA TYPU: " << typeName << "\n";
...
void demoSortUI() {
    ShellSortFrankLazarus<int> sorter;
...
int main() {
    ...
    do {
        ...
        cout << "2. Testy ShellSort Frank-Lazarus dla int i float\n";
        cout << "0. Wyjście\n";
        cout << "Wybierz opcję: ";
        cin >> option;
        ...
        switch (option) {
            case 1:
                ...
                break;
            case 2:
                testShellSortFrankLazarus<int>("int");
                testShellSortFrankLazarus<float>("float");
                break;
            case 0:
